...
class AttractionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @attraction.save
        format.html { redirect_to @attraction, notice: "Attraction created." }
        format.json { render :show, status: :created, location: @attraction }
      else
        format.html { render :new }
        format.json { json_error_format }
      end
    end
  end
  ...
  def update
    respond_to do |format|
      if @attraction.update(attraction_params)
        format.html { redirect_to @attraction, notice: "Update successful." }
  ...
  def destroy
    @attraction.destroy
    respond_to do |format|
      format.html { redirect_to attractions_url, notice: "Destroyed." }
